...
public class Recursion {
	...
	*/
	...
	public boolean palindrome(String word){
		...
		boolean value=true;
		return palHelp(0,word.length()-1,word,value);
	} 
	
	public boolean palHelp (int first, int last, String word, boolean value){
		if (first>=last){
			return value;
		}
		else{
			...
			return palHelp(first+1,last-1,word,value);
		}
	}
        /* Precondition:  n >= 0
