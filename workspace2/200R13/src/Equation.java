...
public class Equation {
	...
	private Hashtable<String, Boolean> bst;
	...
	public String line(Hashtable<String,Boolean> symbolTable) throws ParseException{
		TreeNode root;
		if(nextToken==null){
...
//			tree.preorderTraverse();
		...
		symbolTable.put(key, test);//insertItem(iv);
		//bst=symbolTable;
		return key;
	}
