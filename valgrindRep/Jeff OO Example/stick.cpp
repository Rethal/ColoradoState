...
int stick::filePose(PoseDisplay& pose, ifstream& inFile = INFILE) {
...
int stick::fileDistPrint(ifstream& inFile = INFILE, string outFile = OUTFILE) {
	if (legalFile(inFile) != -1) {
...
int stick::legalFile(ifstream& inFile = INFILE) {
	string lineOf75 = "";
	int lineCount = 0;
