...
int stick::filePose(PoseDisplay& pose, ifstream& inFile = stick.INFILE) {
...
int stick::fileDistPrint(string outFile = stick.OUTFILE, ifstream& inFile = stick.INFILE) {
	if (legalFile(inFile) != -1) {
...
int stick::legalFile(ifstream& inFile = stick.INFILE) {
	string lineOf75 = "";
	int lineCount = 0;
...
bool stick::openOutFile(string outFile = OUTFILE) {
