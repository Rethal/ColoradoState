/** @file       logic.h
 *  @brief      ... header for logic.c
 *  @details    ... Declares what functions can be written in logic.c
 *                  defines what bit terms "FALSE" and "TRUE" hold, 
 *                  includes assert function and standard input/output
 *
